...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href={{asset('templateSneat/assets/img/favicon/favicon.ico')}}" />
    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
               ...
               -->
                <li class="menu-item ">
                    <a href="{{route('dreamIndex')}}" class="menu-link text-primary">
                        <img src="{{ asset('assets/img/konu.png') }}" class="menu-icon-img">
                        <div data-i18n="Analytics">Rüya Tabircisi</div>
                    </a>
                </li>
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    ...
                    <div class="navbar-nav align-items-center">
                        <div class="nav-item d-flex align-items-center">
                            ...
                            <input type="text" class="form-control border-0 shadow-none" placeholder="Anahtar kelimenizi giriniz..." aria-label="Search...">
                        </div>
                    </div>
                    <!-- /Search -->
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="http://127.0.0.1:8000/user/profile">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                       ...
                                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        <i class="bx bx-power-off me-2 text-primary"></i>
                                        <span>Çıkış Yap</span>
                                    </a>
